...
describe('weather runtime realtime contract', () => {
  ...
  it('routes all dashboard source families into their UI buckets', async () => {
    ...
    const sources = [
      ...
      {
        id: 'meteofrance_20114002',
        pollMs: 60_000,
        fetch: vi.fn().mockResolvedValue(reading('meteofrance_20114002', '2026-05-25T08:00:00.000Z', 8)),
      },
      {
        id: 'meteofrance_20093002',
        pollMs: 60_000,
      ...
      {
        id: 'meteofrance_20342001',
        pollMs: 60_000,
        fetch: vi.fn().mockResolvedValue(reading('meteofrance_20342001', '2026-05-25T08:00:00.000Z', 10)),
      },
      {
        id: 'meteofrance_20041001',
        pollMs: 60_000,
        fetch: vi.fn().mockResolvedValue(reading('meteofrance_20041001', '2026-05-25T08:00:00.000Z', 19)),
      },
      {
    ...
    expect(snapshot.windData.lfks.live.windSpeed).toBe(10);
    expect(snapshot.windData.lfvh.live.windSpeed).toBe(19);
